    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="">
                <a href="index.html" class="link-to-home"><img style="width: 50px; height:auto;" src="{{ asset('assets/images/logo.jpg') }}" alt="logo"></a>
            </a>
        </div>
        <!-- Top Menu Items -->
...
<!-- Code source  https://bootsnipp.com/snippets/eNe4v -->
